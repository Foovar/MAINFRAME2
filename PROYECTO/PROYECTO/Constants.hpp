...
#define CHARACTER_STATE_STAND 6

#define CHARACTER__PRINCESS_STATE_RUNING 7
#define CHARACTER__PRINCESS_STATE_SLEEP 8
#define CHARACTER__PRINCESS_STATE_STAND 9
